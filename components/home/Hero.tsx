...
const heroBlurDataURL = 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIwMCIgaGVpZ2h0PSI4MDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHJlY3Qgd2lkdGg9IjEwMCUiIGhlaWdodD0iMTAwJSIgZmlsbD0iIzFhMWExYSIvPjwvc3ZnPg=='
    ...
    if (heroSlides && heroSlides.length > 0) {
        ...
        featuredVillas = heroSlides
            ...
            .map(slide => ({
                ...
                image: slide.villa.images?.[0] || `https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&fm=webp&q=65&auto=format,compress&fit=crop`,
        ...
        if (!error && villas) {
            featuredVillas = villas.map(villa => ({
                ...
                image: villa.images?.[0] || `https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&fm=webp&q=65&auto=format,compress&fit=crop`,
    ...
    const fallbackVillas = [
        {
            ...
            image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&fm=webp&q=65&auto=format,compress&fit=crop',
            bedrooms: 3,
            guests: 6,
            price: 4500000,
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&fm=webp&q=65&auto=format,compress&fit=crop',
            bedrooms: 4,
            guests: 8,
            price: 5500000,
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1602002418082-a4443e081dd1?w=800&fm=webp&q=65&auto=format,compress&fit=crop',
            bedrooms: 2,
            guests: 4,
            price: 3800000,
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1540541338287-41700207dee6?w=800&fm=webp&q=65&auto=format,compress&fit=crop',
            bedrooms: 5,
            guests: 10,
            price: 6200000,
        },
