    ...
    const fallbackTestimonials = [
        {
            ...
            guest_image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&fm=webp&q=70&auto=format,compress&fit=crop",
            featured: true,
        ...
        },
        {
            ...
            guest_image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&fm=webp&q=70&auto=format,compress&fit=crop",
            featured: true,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },
        {
            ...
            guest_image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&fm=webp&q=70&auto=format,compress&fit=crop",
            featured: true,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        },
